...
IMAGE_CMD_sdcard () {
	...
	mkfs.vfat -n "${BOOTDD_VOLUME_ID}" -S 512 -C ${WORKDIR}/boot.img $BOOT_BLOCKS
        ...
        mcopy -i ${WORKDIR}/boot.img -s ${DEPLOY_DIR_IMAGE}/s812_autoscript ::s812_autoscript
        mcopy -i ${WORKDIR}/boot.img -s ${DEPLOY_DIR_IMAGE}/meson8m2_n200_2G.dtb ::meson8m2_n200_2G.dtb
